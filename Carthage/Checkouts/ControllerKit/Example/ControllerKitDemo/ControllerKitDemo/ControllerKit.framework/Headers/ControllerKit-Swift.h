...
- (nonnull instancetype)initWithName:(NSString * __nonnull)name serviceIdentifier:(NSString * __nonnull)serviceIdentifier controller:(Controller * __nonnull)controller OBJC_DESIGNATED_INITIALIZER;
- (void)start;
- (void)stop;
...
SWIFT_CLASS("_TtC13ControllerKit6Server")
@interface Server : NSObject <NSNetServiceDelegate, GCDAsyncSocketDelegate>
